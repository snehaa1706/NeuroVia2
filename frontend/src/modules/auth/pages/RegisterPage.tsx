...
import { Brain, Eye, EyeOff, Shield, ArrowRight, Activity, Heart, Users, Upload, Camera } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit} className="space-y-[1.1rem]">
            ...
            {step === 3 && (
              <>
                ...
                <div className="flex gap-3 mt-4">
                  <button type="button" onClick={() => setStep(2)} className="flex-1 py-[0.85rem] bg-transparent text-[#4a5578] font-medium text-[0.95rem] rounded-[10px] border border-[#d2c8b98c] hover:border-[#6b7c52] transition-colors">
                    Back
                  </button>
